...
export default function CreateTokenManage() {
  ...
  useEffect(() => {
    ...
    } else if (library._network.chainId === 80001) {
      setCoin('Polygon');
      managecontractAddr = CREATE_TOKEN_MANAGE_ADDRESS.polygon;
    }
  ...
  const SetFee = async () => {
    ...
    try {
      await manage_contract.initFee(
        ethers.utils.parseUnits(FeeInfo[0].fee.toString(), 18),
    ...
    <GridContainer justifyContent="center">
      <GridItem xs={12} sm={12} md={9}>
        <Card>
          <CardHeader color="danger">
            <Primary>
              <h4 className={classes.cardTitleWhite}>Setting Fee</h4>
            </Primary>
            <p className={classes.cardCategoryWhite}>
              {/* <Stack direction="row" spacing={5}> */}
              <Warning />
              You can set some fees for presale. But you should be contract manger.
              {/* </Stack> */}
            </p>
          </CardHeader>
          <CardBody>
          ...
          <GridContainer justifyContent="center">
            <Button variant="outlined" onClick={(e) => SettingButtonClick()} color="info">
              Setting
            </Button>
          </GridContainer>
          <p />
      ...
      <GridItem xs={12} sm={12} md={3}>
        <Card>
          ...
          {/* <CardFooter> */}
          <GridContainer justifyContent="center">
            <Button variant="outlined" onClick={(e) => WithdrawButtonClick()} color="info">
              Withdraw
            </Button>
          </GridContainer>
          <p></p>
