          ...
          <Card>
            ...
            <CardBody>
              ...
              <GridContainer justifyContent="center">
                <p>
                  <b>
                    {infobj.raised}/{infobj.hardcap} {coin} Raised
                  </b>
                </p>
              </GridContainer>
              {/* <Divider textAlign="center"></Divider> */}
              <GridContainer justifyContent="center">
                <Stack direction="row" spacing={5}>
                  <TextField
                    type="number"
                    id="deposit_amount"
                    placeholder={'1' + coin + '=' + infobj.tokenrate + ' ' + data.tokeninfo.symbol}
                    label=""
                    variant="standard"
                  />
              ...
              {!lockflag && (
                <GridContainer justifyContent="center">
                  <p>If you participated in the presale please click the claim button below to claim your tokens!</p>
                </GridContainer>
              )}
                ...
                <GridContainer justifyContent="center">
                  <Stack direction="row" spacing={10}>
                    <Info>
                      ...
                      <Primary>{infobj.buyamount}</Primary>
                    </Info>
                    <Info>
                      <p>Your Claimable Tokens:</p>
                      <Primary>
                        {infobj.reservetoken}&nbsp;{data.tokeninfo.symbol}
                      </Primary>
                    </Info>
                  </Stack>
                </GridContainer>
              ...
              {!lockflag && (
                <GridContainer justifyContent="center">
                  <p>You can withdraw your coin if the presale is failed.</p>
                </GridContainer>
              )}
              ...
              {!lockflag && (
                <GridContainer justifyContent="center">
                  <Button
                    color="warning"
                    variant="contained"
                    disabled={withdrawflag}
                    onClick={(e) => withdrawButtonClick()}
                  >
                    Withdraw
                  </Button>
                </GridContainer>
              ...
              {lockflag && (
                <GridContainer justifyContent="center">
                  <p>
                    Presale is successfuly ended. You can claim tokens after liqudity lock has been finished. Only
                    presale owner can do it.
                  </p>
                </GridContainer>
              )}
                  ...
                  <table className={classes.table}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <b>{infobj.supply}</b> {data.tokeninfo.symbol}
                        </td>
                        <td></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td>
                          <Info>Tokens for Presale:</Info>
                        </td>
                        <td>
                          <b>{infobj.presale_amount}</b> {data.tokeninfo.symbol}
                        </td>
                        <td></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td>
                          <Info>Tokens for Liquidity:</Info>
                        </td>
                        <td>
                          <b>{infobj.liqudity_amount}</b> {data.tokeninfo.symbol}
                        </td>
                        <td></td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <Primary>
                            <b>Estimated Initial Marketcap:</b>
                          </Primary>
                        </td>
                        <td>
                          <b>${marketcap}</b>
                      ...
                      <tr>
                        <td></td>
                        <td>
                          <Info>Presale Rate:</Info>
                        </td>
                        <td>
                          <b>{infobj.tokenrate}</b>
                        </td>
                        <td></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td>
                          <Info>Liqudity Rate:</Info>
                        </td>
                        <td>
                          <b>{infobj.listingrate}</b>
                        </td>
                        <td></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td>
                          <Info>Liqudity Percent:</Info>
                        </td>
                        <td>
                          <b>{infobj.liqudity_percent}</b> {'%'}
                        </td>
                        <td></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td>
                          <Info>Minimum Contribution:</Info>
                        </td>
                        <td>
                          <b>{infobj.mincap}</b>
                        </td>
                      ...
                      <tr>
                        <td></td>
                        <td>
                          <Info>Maximum Contribution:</Info>
                        </td>
                        <td>
                          <b>{infobj.maxcap}</b>
                        </td>
                      ...
                      <tr>
                        <td></td>
                        <td>
                          <Info>Presale Start time:</Info>
                        </td>
                        <td>
                          <b>{infobj.starttime}</b>
                        </td>
                        <td></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td></td>
                        <td>
                          <Info>Liqudity End time:</Info>
                        </td>
                        <td>
                          <b>{infobj.lqendtime}</b>
                        </td>
                        <td></td>
                      </tr>
                    </tbody>
        ...
        <GridItem xs={12} sm={12} md={4}>
            ...
            <CardBody>
              ...
              {warning_falg.token_dump && (
                <div>
                  ...
                  <p>
                    Too many tokens are held outside this sale. Make sure these tokens are burned, locked or the owner
                    has a valid reason to hold them. Tokens held by teams can be sold to pull out liquidity and should
              ...
              {warning_falg.max_contribution && (
                <div>
                  ...
                  <p>
                    This sale has a very high maximum contribution ratio to hardcap allotment. A few users might be able
                    to buy large portions of the supply
                  </p>
                </div>
              )}
            </CardBody>
          ...
          <Card>
            ...
            <CardBody>
              <GridContainer justifyContent="center">
                <Link
                  href={'https://tokensniffer.com/token/' + data.info.sale_token}
                  target="_blank"
                  color="success"
                  underline="hover"
                >
